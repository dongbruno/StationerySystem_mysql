 ...
 * @see citi.hibernate.entity.Staff
...
public class StaffHome {
	...
	public Staff findById(java.lang.String id) {
		...
		try {
			Staff instance = (Staff) sessionFactory.getCurrentSession().get("citi.hibernate.entity.Staff", id);
			if (instance == null) {
	...
	public List findByExample(Staff instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("citi.hibernate.entity.Staff")
