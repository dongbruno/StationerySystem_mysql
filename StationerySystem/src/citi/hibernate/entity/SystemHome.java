...
/**
 * Home object for domain model class System.
 * @see citi.hibernate.entity.System
 * @author Hibernate Tools
 */
public class SystemHome {

	private static final Log log = LogFactory.getLog(SystemHome.class);
	...
	public void persist(System transientInstance) {
		log.debug("persisting System instance");
		try {
	...
	public System merge(System detachedInstance) {
		...
		try {
			System result = (System) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public System findById(java.lang.Integer id) {
		...
		try {
			System instance = (System) sessionFactory.getCurrentSession().get("citi.hibernate.entity.System", id);
			if (instance == null) {
	...
	public List findByExample(System instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("citi.hibernate.entity.System")
